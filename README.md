...
- **Repo Kümesi:** `platform-eventing`
- **Bounded Context:** `platform`
- **Ana Capability:** Kafka/event-streaming platform standards
- **Dönüşüm Wave:** 0
...
- `Kafka/event-streaming platform standards` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
